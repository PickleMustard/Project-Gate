...
void godot::Ordinary::InitialEventConnector() {
  //connect("StepOnEvent", callable_mp(this, &godot::Tile::TileSteppedOnEvent));
  //connect("StepOffEvent", callable_mp(this, &godot::Ordinary::TileSteppedOffEvent));
}
...
void godot::Ordinary::TileSteppedOnEvent(godot::Variant entity) {

}

void godot::Ordinary::TileSteppedOffEvent(godot::Variant entity) {
