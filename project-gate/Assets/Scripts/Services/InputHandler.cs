...
namespace ProjGate.Services
{
    public partial class InputHandler : Node
    {
        ...
        [Signal]
        public delegate void AltClickDownEventHandler();

        [Signal]
        public delegate void AltClickUpEventHandler();
        ...
        public override void _Input(InputEvent @event)
        {
            ...
            {
                EmitSignal(SignalName.AltClickDown);
            }
            else if (Input.IsActionJustReleased("mouse_right"))
            {
                EmitSignal(SignalName.AltClickUp);
            }
