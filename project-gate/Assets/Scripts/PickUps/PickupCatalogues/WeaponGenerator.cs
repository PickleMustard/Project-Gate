...
namespace ProjGate.Pickups
{
  public partial class WeaponGenerator : Resource
  {
    ...
    public BaseWeapon GenerateWeapon(string weaponPath)
    {
      BaseWeapon generatedWeapon = new BaseWeapon();
    ...
    public BaseGrenade GenerateGrenade(string grenadePath)
    {
      if (grenadePath == "none")
      {
        return null;
      ...
      BaseGrenade generatedGrenade = new BaseGrenade();
