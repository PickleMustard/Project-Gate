...
namespace ProjGate.TargetableEntities
{
    ...
    public partial class BaseCharacter : TargetableEntity
    {
        ...
        [Export]
        public Godot.Collections.Array<BaseAbility> Abilities { get; private set; } = new Godot.Collections.Array<BaseAbility>();
        ...
        public void GenerateCharacter(string name, BaseWeapon weapon, BaseGrenade grenade, Array<WEAPON_PROFICIENCIES> proficiencies,
            ...
            int turnPriority, Texture2D icon, Array<BaseAbility> characterAbilities)
        {
            ...
            this.Icon = icon;
            this.Abilities = new Godot.Collections.Array<BaseAbility>(characterAbilities);
        }
...
#endif
            UnitController UnitMovement = GetTree().GetNodesInGroup("UnitControl")[0] as UnitController;
            Connect(SignalName.UpdateMainCharacter, UnitMovement.UpdateCharacter);
            Connect(SignalName.UpdateMainCharacter, CommunicationBus.Instance.UpdateCharacterCall);
