...
namespace ProjGate.TargetableEntities
{
  public partial class CharacterGenerator : Resource
  {
    ...
    public BaseCharacter GenerateCharacter(string characterConfiguration)
    {
      BaseCharacter createdCharacter = new BaseCharacter();
      ...
      Array<BaseCharacter.WEAPON_PROFICIENCIES> proficiencies = ChooseProficiencies((Array)parsedData["Potential-Proficiencies"]);
      ...
      createdCharacter.GenerateCharacter(characterName,
          startingWeapon,
          startingGrenade,
          proficiencies,
          movementRange,
    ...
    private Array<BaseCharacter.WEAPON_PROFICIENCIES> ChooseProficiencies(Array Proficiencies)
    {
      Array<BaseCharacter.WEAPON_PROFICIENCIES> generatedProficiencies = new Array<BaseCharacter.WEAPON_PROFICIENCIES>();
      ...
      for (int i = 0; i < proficientAmount; i++)
      {
        ...
        generatedProficiencies[(int)type] = BaseCharacter.WEAPON_PROFICIENCIES.skilled;
      ...
      for (int i = 0; i < passableAmount; i++)
      {
        ...
        generatedProficiencies[(int)type] = BaseCharacter.WEAPON_PROFICIENCIES.passable;
      ...
      for (int i = 0; i < possibleClumsyWeapons.Count; i++)
      {
        ...
        generatedProficiencies[(int)type] = BaseCharacter.WEAPON_PROFICIENCIES.clumsy;
      }
