...
public partial class EnemyGenerator : Resource
{
    ...
    public Character GenerateEnemy(string configurationPath)
    {
        ...
        enemy.GenerateCharacter(characterName, startingWeapon, startingGrenade, proficiencies, movementRange, actionPoints, characterHealth, accumulationRate, requeueSpeed, turnPriority, CurrencyDroppedOnDeath);
        return enemy;
